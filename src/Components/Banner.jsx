...
<Slider></Slider>
        ...
        <section className=" max-w-6xl mx-auto mt-12 flex items-center justify-center">
          <div className="max-w-3xl p-8 rounded-3xl bg-[#DDF59D] dark:bg-gray-800/80 text-center shadow-2xl">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-900 dark:text-gray-100 leading-tight">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold my-8 text-center bg-clip-text text-transparent bg-linear-to-r from-green-400 to-blue-500">
          Manage Your Finances With Ease
        </h2>
      </div>

     
      <div className='flex flex-col sm:flex-row justify-center items-center gap-4 mt-8 max-w-2xl mx-auto px-4'>
        <div className="cart">
          <div className="cart2">
            <span className='text-2xl sm:text-3xl md:text-4xl text-gray-900 dark:text-white'>Balance</span>
            <p className='text-lg sm:text-xl md:text-2xl mt-2 text-gray-800 dark:text-gray-200'>{balance} Taka</p>
          </div>
        </div>

        <div className="cart">
          <div className="cart2">
            <span className='text-2xl sm:text-3xl md:text-4xl'>Income</span>
            <p className='text-lg sm:text-xl md:text-2xl mt-2'>{income} Taka</p>
          </div>
        </div>

        <div className="cart">
          <div className="cart2">
            <span className='text-2xl sm:text-3xl md:text-4xl'>Expenses</span>
            <p className='text-lg sm:text-xl md:text-2xl mt-2'>{expenses} Taka</p>
          </div>
        </div>
      </div>
